...
export const Banner = () => {
    ...
    const toRotate = [ "Software Design & Development", "Database & Big Data Management", "Information Systems Analyst"];
                     ...
                     <TrackVisibility>
                        {({ isVisible }) => 
                            <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                ...
                                <button onClick={() => console.log('temporary')}>Let's connect <ArrowRightCircle size={25}/></button>
